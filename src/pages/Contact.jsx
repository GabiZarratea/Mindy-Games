  ...
  return (
    <div className='min-h-[83.9vh]'>
      <div className='flex flex-col justify-center items-center my-2'>
        <p className='font-bold text-2xl text-slate-800'>Contact</p>
        <p className='font-semibold text-xl text-slate-800'>You can ask us what you need</p>
      </div>
      <div className='flex flex-col items-center'>
        <img src="/playing.jpg" alt="Playing" className='w-[40%] my-2' />
        <p className='font-semibold text-slate-800'>You can ask us what day from 2:00 pm until 7:00 pm.</p>
        <div className='flex justify-between w-[40%] my-4'>
